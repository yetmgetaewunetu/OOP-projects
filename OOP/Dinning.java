...
public class Dinning extends JFrame implements ActionListener{
    Resizer resizer = new Resizer();
    JButton p1, p2,p3,p4,p5,p6, home;
    public Dinning(){
        this.setDefaultCloseOperation(EXIT_ON_CLOSE);
        this.setSize(700, 800);
        this.setTitle("DINNING TABLES");
        ...
        ImageIcon sofa1 = resizer.resizeImageIcon(new ImageIcon("din1.jpg"), 700, 500);
        String S1 = "<html> Price --> $300(fixed price) <br>Color--> Grey <br>made in --> china</html>";
        ...
        p1.setForeground(Color.decode("#03a9fc"));
        ...
        ImageIcon sofa2 = resizer.resizeImageIcon(new ImageIcon("din2.jpg"), 700, 500);
        String S2 = "<html> Price --> $300(fixed price) <br>Color--> wood<br>made in --> china</html>";
        ...
        p2.setForeground(Color.decode("#03a9fc"));
        ...
        ImageIcon sofa3 = resizer.resizeImageIcon(new ImageIcon("din3.jpg"), 700, 500);
        String S3 = "<html> Price --> $300(fixed price) <br>Color--> White<br>made in --> china</html>";
        ...
        p3.setForeground(Color.decode("#03a9fc"));
        ...
        ImageIcon sofa4 = resizer.resizeImageIcon(new ImageIcon("din4.jpg"), 700, 500);
        String S4 = "<html> Price --> $300(fixed price) <br>Color--> white<br>made in --> china</html>";
        ...
        p4.setForeground(Color.decode("#03a9fc"));
        ...
        ImageIcon sofa5 = resizer.resizeImageIcon(new ImageIcon("din5.jpg"), 700, 500);
        String S5 = "<html> Price --> $300(fixed price) <br>Color--> white<br>made in --> china</html>";
        ...
        p5.setForeground(Color.decode("#03a9fc"));
        ...
        ImageIcon sofa6 = resizer.resizeImageIcon(new ImageIcon("din6.jpg"), 700, 500);
        String S6= "<html> Price --> $300(fixed price) <br>Color--> Black<br>made in --> china</html>";
        ...
        p6.setForeground(Color.decode("#03a9fc"));
    ...
    public void writer(){
        try{
                    ...
                    buffer.write("Dinning Table" + "," + "300" + "," +   "1" + "\n");
                    buffer.flush();
