...
public class Beds extends JFrame implements ActionListener{
    Resizer resizer = new Resizer();
    JButton p1, p2,p3,p4,p5,p6, home;
    public Beds(){
        this.setDefaultCloseOperation(EXIT_ON_CLOSE);
        this.setSize(700, 800);
        this.setTitle("Beds Display");
        ...
        sofaPanel.setBackground(Color.black);
        ...
        ImageIcon sofa1 = resizer.resizeImageIcon(new ImageIcon("bed1.jpg"), 700, 500);
        String S1 = "<html> Price --> $1000 <br>made from--> pure wood <br>made in --> china</html>";
        ...
        ImageIcon sofa2 = resizer.resizeImageIcon(new ImageIcon("bed2.jpg"), 700, 500);
        String S2 = "<html> Price --> $1000 <br>made from--> pure wood & comfy cushions<br>made in --> china</html>";
        ...
        ImageIcon sofa3 = resizer.resizeImageIcon(new ImageIcon("bed3.jpg"), 700, 500);
        String S3 = "<html> Price --> $1000 <br>made from--> pure wood & comfy cushions<br>made in --> china</html>";
        ...
        ImageIcon sofa4 = resizer.resizeImageIcon(new ImageIcon("bed4.jpg"), 700, 500);
        String S4 = "<html> Price --> $1000 <br>made from--> pure wood & comfy cushions<br>made in --> china</html>";
        ...
        ImageIcon sofa5 = resizer.resizeImageIcon(new ImageIcon("bed5.jpg"), 700, 500);
        String S5 = "<html> Price --> $1000 <br>made from--> pure wood & comfy cushions<br>made in --> china</html>";
        ...
        ImageIcon sofa6 = resizer.resizeImageIcon(new ImageIcon("bed6.jpg"), 700, 500);
        String S6= "<html> Price --> $1000 <br>made from--> pure wood & comfy cushions<br>made in --> china</html>";
